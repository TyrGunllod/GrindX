...
def buscar_por_codigo(
    ...
    try:
        sql = text(
            "SELECT B1_COD, B1_DESC FROM SB1010 WHERE B1_COD LIKE :codigo AND (D_E_L_E_T_ = '' OR D_E_L_E_T_ = ' ' OR D_E_L_E_T_ IS NULL) AND B1_MSBLQL = '2' ORDER BY B1_COD"
        )
...
def buscar_por_descricao(
    ...
    try:
        sql = text(
            "SELECT B1_COD, B1_DESC FROM SB1010 WHERE B1_DESC LIKE :descricao AND (D_E_L_E_T_ = '' OR D_E_L_E_T_ = ' ' OR D_E_L_E_T_ IS NULL) AND B1_MSBLQL = '2' ORDER BY B1_COD"
        )
