...
class Modulo(Base):
    ...
    slug = Column(String(100), unique=True, nullable=False) # Identificador único para a URL
    url = Column(String(255), nullable=False) # Caminho do arquivo HTML (ex: /modules/users/index.html)
