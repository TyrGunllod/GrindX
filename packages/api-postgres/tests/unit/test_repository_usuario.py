...
class TestUsuarioRepositoryBusca:
    ...
    def test_buscar_por_id_encontra_usuario(self, repository: UsuarioRepository, usuario_base: Usuario):
    ...
    def test_buscar_por_username_encontra(self, repository: UsuarioRepository, usuario_base: Usuario):
    ...
    def test_buscar_por_email_encontra(self, repository: UsuarioRepository, usuario_base: Usuario):
...
class TestUsuarioRepositoryCrud:
    ...
    def test_criar_usuario_novo(self, repository: UsuarioRepository, db_session: Session):
    ...
    def test_atualizar_usuario(self, repository: UsuarioRepository, usuario_base: Usuario):
    ...
    def test_desativar_usuario(self, repository: UsuarioRepository, usuario_base: Usuario):
    ...
    def test_deletar_usuario(self, repository: UsuarioRepository, usuario_base: Usuario):
...
class TestUsuarioRepositoryListagem:
    ...
    def test_listar_ativos(self, repository: UsuarioRepository, usuarios_multiplos: list):
    ...
    def test_listar_ativos_paginado(self, repository: UsuarioRepository, usuarios_multiplos: list):
    ...
    def test_listar_todos(self, repository: UsuarioRepository, usuarios_multiplos: list):
    ...
    def test_listar_por_role(self, repository: UsuarioRepository, usuarios_multiplos: list):
    ...
    def test_listagem_ordenada_por_username(self, repository: UsuarioRepository, usuarios_multiplos: list):
...
class TestUsuarioRepositoryValidacoes:
    ...
    def test_username_unico(self, repository: UsuarioRepository, usuario_base: Usuario, db_session: Session):
